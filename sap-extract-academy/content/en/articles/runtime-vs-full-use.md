...
The compliant alternatives are ODP via OData, or SLT replication. On a Runtime License, SLT is not available — so the only compliant path for third-party tools is ODP via OData.
