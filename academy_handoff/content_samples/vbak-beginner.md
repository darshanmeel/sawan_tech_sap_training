...
steps:
  ...
  - id: step-02
    ...
    explanation: 'The extraction process needs a dedicated SAP user with minimal permissions. Never use a dialog user. Create a Communication or System type user via <a href="https://help.sap.com/docs/SAP_NETWEAVER_750/.../SU01.html">SU01</a>.'
    sapTransaction:
      code: SU01
      menuPath: "User → Create"
      helpUrl: "https://help.sap.com/docs/SAP_NETWEAVER_750/.../SU01.html"
    codeBlock:
      language: plaintext
      content: |
  ...
  - id: step-03
    ...
    explanation: 'The user needs three authorization objects: <a href="https://help.sap.com/docs/SAP_NETWEAVER_750/.../S_RFC.html">S_RFC</a> (RFC call), S_TABU_DIS (table display), and S_ODP_READ (ODP read access).'
    sapTransaction:
      code: PFCG
      menuPath: "Role → Create → Authorizations"
      helpUrl: "https://help.sap.com/docs/SAP_NETWEAVER_750/.../PFCG.html"
